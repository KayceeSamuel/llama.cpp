...
template [[host_name("kernel_mul_mm_nf4dq_f32")]]   kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nf4dq,   64,    dequantize_nf4dq,   float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_nf4dq_f16")]]   kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nf4dq,   64,    dequantize_nf4dq,   float,  float4x4,  half, half2x4>;
...
template [[host_name("kernel_mul_mm_id_nf4dq_f32")]]   kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nf4dq,   64,    dequantize_nf4dq,   float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_id_nf4dq_f16")]]   kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nf4dq,   64,    dequantize_nf4dq,   float,  float4x4,  half, half2x4>;
